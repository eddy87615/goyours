...
import "./jobs.css";
import { OfficialJob } from "../../components/jobs";
import { Pagination, LoadingBear } from "../../components/common";
import { SearchBarCareer } from "../../components/search";
    ...
    <>
      ...
      <div className="workingholiday">
        <div className="jobListKv">
          <SearchBarCareer onSearch={handleSearch} initialFilters={initialFilters} />
        </div>
        <OfficialJob
          jobList={currentJobs}
