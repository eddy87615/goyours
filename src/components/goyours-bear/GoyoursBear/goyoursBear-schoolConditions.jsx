...
export default function GoyoursBearSchoolCondition() {
  return (
    <span className="goyoursbear-component-school">
      <svg version="1.1" id="goyoursBear" viewBox="0 0 1200 348.7" width={250}>
        <path
          className="goyoursbear-line"
          d="M0,337.5h900c0,0-13.5-150.2,68.7-211.6c0,0-5.4-16.2-40.1-28c0,0-12.5-5.6-15.7-16.7c0,0-1.1-14.6,0.7-16.9
