...
export default function Opening() {
  ...
  return (
    <div className="openingPage">
      <div className="goyoursbearWrapper">
        {/* <img src="/src/assets/goyoursbear-B.svg" alt="black goyours bear" /> */}
        <svg version="1.1" id="logo" x="0px" y="0px" viewBox="0 0 284.2 338">
          <path
            className="st0"
            d="M8.6,337.5c0,0-13.5-150.2,68.7-211.6c0,0-5.4-16.2-40.1-28c0,0-12.5-5.6-15.7-16.7c0,0-1.1-14.6,0.7-16.9
