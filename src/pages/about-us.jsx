  ...
  return (
	...
	h1.8c0,0,3.7-17.8,22.7-10.1c0,0,11.1,5.6,5.8,20.3c0,0,0.2,2.5,0,4.8c0,0,46.4,29.8,51.6,84.9c0,0,79.4,32.1,70.9,213.5"
        ...
        <p>
          ...
          評鑑A級私立就業服務機構證號3508
          <br />
          我們是專業合法的人力仲介與留學代辦假，專注於日本市場，提供日本就職、留學、打工度假等完整服務。
          <br />
          我們透過豐富的經驗，幫助你找到最適合的方式，開啟你的日本之路。
          <br />
          <span>GOYOURS</span>
          堅持以同理心出發，不以利益為導向，透過專業分析，幫助每位學員不浪費時間、不走彎路，找到最有效率的進場方式。
          <br />
          我們擁有超過十年的經驗，累積上萬件成功案例，從簽證申請到日本工作安排，全程陪伴你的成長與發展。
          <br />
